...
%% Generating FIS with 2 MFs and Polynomial Output.
...
suptitle('TSK model 3: MFs before Training')
saveas(gcf, 'TSK_model_3/MFs_before_Training.png')
...
suptitle('TSK model 3: MFs after Training')
saveas(gcf, 'TSK_model_3/MFs_after_Training.png')
...
saveas(gcf,'TSK_model_3/Learning_Curves.png')
...
plot(error)
title('TSK model 3: Prediction Errors')
saveas(gcf,'TSK_model_3/Error.png')

figure;

plot(1:length(checkData),checkData(:,5),'.r', 1:length(output),output,'.b')
title('TSK model 3: Actual and Predicted Values')
legend('Actual','Predicted')
saveas(gcf,'TSK_model_3/Actual_Predicted_.png')
...
% RMSE = 0.111010  NMSE = 0.060817  NDEI = 0.246611  R2 = 0.939183
% Elapsed time is 51.284584 seconds.