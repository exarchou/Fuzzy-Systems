...
%% Generating FIS with 3 MFs and Polynomial Output.
...
suptitle('TSK model 4: MFs before Training')
saveas(gcf, 'TSK_model_4/MFs_before_Training.png')
...
suptitle('TSK model 4: MFs after Training')
saveas(gcf, 'TSK_model_4/MFs_after_Training.png')
...
saveas(gcf,'TSK_model_4/Learning_Curves.png')
...
plot(error)
title('TSK model 4: Prediction Errors')
saveas(gcf,'TSK_model_4/Error.png')

figure;

plot(1:length(checkData),checkData(:,5),'.r', 1:length(output),output,'.b')
title('TSK model 4: Actual and Predicted Values')
legend('Actual','Predicted')
saveas(gcf,'TSK_model_4/Actual_Predicted_.png')
...
% RMSE = 0.106792  NMSE = 0.056283  NDEI = 0.237240  R2 = 0.943717
% Elapsed time is 1172.397660 seconds.